                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr class="table-info">
                                                <td><strong>Total:</strong>
                                                    <fmt:formatNumber value="${order.getTotal()}" type="number" /> VND
                                                </td>
                                            </tr>
                                            <tr class="table-info">
                                            ...
                                            <tr class="table-info">
                                                <td><strong>Receiver's name:</strong> ${order.getReceiverName()}</td>
                                            </tr>
                                            <tr class="table-info">
                                                <td><strong>Receiver's address:</strong> ${order.getReceiverAddress()}
                                                </td>
                                            </tr>
                                            <tr class="table-info">
                                                <td><strong>Receiver's phone:</strong> ${order.getReceiverPhone()}</td>
                                            </tr>
                                        </table>
