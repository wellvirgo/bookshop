                        ...
                        <div class="container mt-5">
                            <div class="row">
                                <div class="col-12 mx-auto">
                                    <form:form method="post" action="/admin/book/update" modelAttribute="selectedBook"
                                        enctype='multipart/form-data'>
                                        <h2 class="mb-3" style="color: burlywood;">Update book</h2>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" style="color: rgb(249, 75, 75);">Image
                                                preview</label>
                                            <c:if test="${selectedBook.getImageLink()!=null}">
                                                <img alt="Image preview" id="imagePreview"
                                                    style="width: 250px; height: auto; display: block;"
                                                    src="/images/bookImages/${selectedBook.getImageLink()}" />
                                            </c:if>
